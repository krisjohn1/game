          ...
          {user ? (
            <>
              <button 
                ...
                className="group relative px-5 py-2 font-black tracking-widest text-black rounded-lg overflow-hidden transition-all hover:scale-105 active:scale-95 flex items-center shadow-[0_0_15px_rgba(251,191,36,0.2)]"
              >
